...
namespace StreamRadio.Services
{
    public class Radio
    {
        ...
        private readonly Dictionary<RadioType, string> _radioStreams = new Dictionary<RadioType, string>
        {
            ...
            {RadioType.Radio10NonStop, "http://playerservices.streamtheworld.com/api/livestream-redirect/TLPSTR15AAC.aac"},
            {RadioType.Radio1090Hits, "http://20403.live.streamtheworld.com/TLPSTR22AAC.aac"},
            {RadioType.QMusicNonStop, "https://icecast-qmusicnl-cdp.triple-it.nl/Qmusic_nl_nonstop_96.mp3"},
